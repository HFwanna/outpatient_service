...
public class DrugMessage {
	...
	public String toString() {
		return "DrugMessage [drug_id=" + drug_id + ", drug_name=" + drug_name
				+ ", drug_message=" + drug_message + ", drug_repertory="
				+ drug_repertory + ", drug_price=" + drug_price + ", drug_type="
				+ drug_type + ", drug_standard=" + drug_standard + "]";
	}
