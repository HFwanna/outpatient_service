					...
					handler:function(){
						...
						if(object!=null){
							for(var i =0;i<object.length;i++){
								//循环把对象属性封装到一个数组中
								arr.push({"dis_diagnose":object[i].dis_diagnose});
								arr.push({"dis_description":object[i].dis_description});
								arr.push({"dis_doctor":object[i].dis_doctor});
								arr.push({"dis_time":object[i].dis_time});
								arr.push({"dis_id":object[i].dis_id});
